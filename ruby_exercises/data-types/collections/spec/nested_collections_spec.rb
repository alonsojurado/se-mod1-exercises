RSpec.describe 'Nested Collections' do
  ...
  xit 'test 2' do
    ...
    thirty_nine = coordinates[2][1] _________
  ...
  xit 'test 6' do
    ...
    pitchers = team[:pitchers]_________
  ...
  xit 'test 9' do
    ...
    num_fielders = team[:fielders].length #could also use .size method ________
  ...
  xit 'test 10' do
    ...
    kenny_is_pitcher = team[:pitchers].include?("Kenny") ________
  ...
  xit 'test 11' do
    ...
    actual = three_day_forecast[ :ref_num] ________
  ...
  xit 'test 12' do
    ...
    actual = three_day_forecast[ :days]   ________
  ...
  xit 'test 13' do
    ...
    actual = three_day_forecast["date"] ________
    expected = "6-21-18"
    expect(actual).to eq(expected)
  end
  ...
  xit 'test 14' do
    ...
    actual = three_day_forecast.keys _________
  ...
  xit 'test 15' do
    ...
    actual = three_day_forecast[ :days][1][ :high] ________
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  xit 'test 16' do
    ...
    actual = three_day_forecast[:days][0].keys ________
  ...
  xit 'test 17' do
    ...
    actual = three_day_forecast[:days][2].values ________
  ...
  xit 'test 18' do
    ...
    actual = three_day_forecast.keys.find { |key| key == "date"} _________
    expected = "date"
    expect(actual).to eq(expected)
  end
  ...
  xit 'test 19' do
    ...
    three_day_forecast[ :days][0][:high] = 99 _______
    expected = {
      days: [
  ...
  xit 'test 20' do
    ...
    three_day_forecast["time"] = "12:30"  _________
    expected = {
      "time" => "12:30",
       days: [
        {high: 70,low: 63,summary: "Mostly Sunny"},
