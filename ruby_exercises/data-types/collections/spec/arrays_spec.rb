...
RSpec.describe 'Arrays' do
  ...
  xit 'test 5' do
    ...
    last_element = world_cup.pop_____
    puts last_element
    puts world_cup
  ...
  xit 'test 7' do
    ...
    actual = band.unshift("Vocals")_____
    puts karaoke
  ...
  xit 'test 8' do
    ...
    first_element = garden.shift______
    puts first_element
    puts garden
